...
EVENT_CONFIGS: Dict[int, Config] = {
    ...
    2006: Config(
        ...
        items=(
            ...
            Item(8, -8240993, 8, "8240993"),
            Item(3, 3810616, 8, "3810616"),
        ),
    ),
    2004: Config(
...
EVENT_SUBCATEGORY_CONFIGS: Dict[int, Config] = {
    ...
    2006: Config(
        ...
        source_column="previous",
        items=(
            Item(2, -5252955, 11, "5252955"),
            Item(21, -3443058, 11, "3443058"),
            Item(22, -1109005, 11, "1109005"),
            Item(23, -5225467, 11, "5225467"),
            Item(24, -1684566, 11, "1684566"),
            Item(25, -1166211, 11, "1166211"),
            Item(26, -177329, 11, "177329"),
            Item(27, -382056, 11, "382056"),
            Item(28, -541977, 11, "541977"),
            Item(29, -673938, 11, "673938"),
            Item(30, -1016938, 11, "1016938"),
        ),
    ),
    2005: Config(
        pdf="bokslut2005.pdf",
